...
public:
    ...
    void update(const double& learning_rate = 0.1);						//update weights	
    int training(const double& learning_rate = 0.1,std::string file="");	//main work, train network
};
